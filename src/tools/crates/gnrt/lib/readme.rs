...
impl Display for LicenseKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        match self {
            ...
            LicenseKind::CC0 => write!(f, "CC0-1.0"),
        }
    }
}
...
static LICENSE_KIND_TO_LICENSE_FILES: LazyLock<HashMap<LicenseKind, Vec<&'static str>>> =
    LazyLock::new(|| {
        ...
        h.insert(
            LicenseKind::MIT,
            vec!["LICENSE-MIT", "LICENSE-MIT.txt", "LICENSE-MIT.md", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"],
        );
        h.insert(
            LicenseKind::BSD3,
            vec!["LICENSE-BSD", "LICENSE-BSD.txt", "LICENSE-BSD.md", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"],
        );
        h.insert(LicenseKind::ISC, vec!["LICENSE-ISC", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h.insert(LicenseKind::Zlib, vec!["LICENSE-ZLIB", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h.insert(LicenseKind::Unicode3, vec!["LICENSE-UNICODE", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h.insert(LicenseKind::BSD3, vec!["LICENSE-BSD", "LICENSE-BSD.txt", "LICENSE-BSD.md", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h.insert(LicenseKind::MPL2, vec!["LICENSE-MPL", "LICENSE-MPL.txt", "LICENSE-MPL.md", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h.insert(LicenseKind::CC0, vec!["LICENSE-CC0", "LICENSE-CC0.txt", "LICENSE-CC0.md", "LICENSE.md", "LICENSE", "LICENCE.txt", "README.md", "Cargo.toml"]);
        h
    });
